import { PrismaClient, UserLevel, SessionType, AuditAction, ProcessingStatus, UserPreferenceType } from '@prisma/client';
...
async function main() {
    ...
    data: [
      {
        ...
        currentStreak: 15,
        levelAchieved: UserLevel.INTERMEDIATE,
      ...
      },
      {
        ...
        currentStreak: 45,
        levelAchieved: UserLevel.ADVANCED,
  ...
  const preferences = [
    { userId: testUser1.id, type: UserPreferenceType.AUDIO_SPEED, key: 'speed', value: '1.0' },
    { userId: testUser1.id, type: UserPreferenceType.VOICE_TYPE, key: 'voice', value: 'female' },
    { userId: testUser1.id, type: UserPreferenceType.DAILY_REMINDER, key: 'enabled', value: 'true' },
    { userId: testUser1.id, type: UserPreferenceType.DAILY_REMINDER, key: 'time', value: '09:00' },
    { userId: testUser1.id, type: UserPreferenceType.DIFFICULTY_AUTO_ADJUST, key: 'enabled', value: 'true' },
    { userId: testUser2.id, type: UserPreferenceType.AUDIO_SPEED, key: 'speed', value: '1.25' },
    { userId: testUser2.id, type: UserPreferenceType.VOICE_TYPE, key: 'voice', value: 'male' },
    { userId: testUser2.id, type: UserPreferenceType.PROGRESS_NOTIFICATIONS, key: 'enabled', value: 'true' },
    { userId: testUser2.id, type: UserPreferenceType.ANALYTICS_OPT_IN, key: 'enabled', value: 'true' }
  ];
